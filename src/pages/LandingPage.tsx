...
const LandingPage = () => {
  return (
    <div>
        ...
        {/* SERVICE SECTION */}
        <div className='flex flex-col gap-8 justify-center items-center h-[90vh]' id='services'>
            <h1 className='text-4xl font-bold text-green-600'>Our Services</h1>
        <div className='md:flex gap-2'> 
            <div className=' flex flex-col gap-4 justify-center items-center p-8 md:w-1/3 text-center'>
                <ChartCandlestick size={30} color="#A60CD2"/>
            ...
            <div className='flex flex-col gap-4 justify-center items-center p-8 md:w-1/3 text-center'>
                <SendToBack size={30} color="#A60CD2"/>
        ...
        {/* CONTACT SECTION */}
        <section className="h-[70vh]" id="contact">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
                <h2 className="mb-4 text-4xl tracking-tight font-semibold leading-tight text-gray-900 ">Transform Your Digital Presence Today</h2>
                <p className="mb-6 font-light text-gray-500  md:text-lg">What do you think? Ready for the next section or something else?</p>
                <div className="flex gap-1">
                <input type="email" id="helper-text" aria-describedby="helper-text-explanation" className="inline-flex bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="Enter your email address"/>
                <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-600 hover:bg-green-500 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Subscribe
                    <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a> 
               </div>
                <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 ">Instant signup. No credit card required. Terms of Service and  <a href="#" className="font-medium text-blue-600 hover:underline dark:text-blue-500">Privacy Policy</a>.</p>
    ...
    {/* FOOTER SECTION */}
    <footer className="p-4 bg-purple-900 sm:p-6">
        <div className="mx-auto max-w-screen-xl">
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-white sm:text-center ">© 2024 <a href="#" className=" hover:underline">Tila Tech Solution™</a>. All Rights Reserved.
                </span>
